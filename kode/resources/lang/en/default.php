...
return [
   ...
   <li class="text-danger"><i class="bi bi-check-circle"></i>Do not close the tab while the process is running</li>',
    ...
    'platform_notes' => [
       ...
       'tiktok' => "The current TikTok API supports only video uploads, allowing captions to be included with the video. Unaudited accounts are restricted to posting to private accounts only. To post to a public account, please apply for account verification.",
       ...
       'youtube' => "The current YouTube API supports only video uploads with optional titles, descriptions, and tags. Note that some features, such as setting a custom thumbnail or publishing to public channels, may require your app to be verified and approved for advanced API access.",
