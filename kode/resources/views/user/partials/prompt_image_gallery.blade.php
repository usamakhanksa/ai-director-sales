        ...
        <div class="card-body d-flex flex-column justify-content-between">
            <div class="image-content-wrap">
                ...
                @if($content->file && $content->file->isNotEmpty())
                    <img src="{{ imageURL(@$content->file->first(), 'content', true) }}" alt="{{ $content->name }}" class="mb-3">
                @else
                    <img src="{{ asset('assets/images/default/placeholder.jpg') }}" alt="No Image" class="mb-3">
                @endif
