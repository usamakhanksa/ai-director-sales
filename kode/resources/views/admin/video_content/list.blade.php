...
@section('content')
     ...
     @if(check_permission('create_content'))
        <div class="i-card-md">
            <div class="card-body">
                @include('partials.prompt_video_content',['content_route' => route("admin.content.video.store")])
            </div>
        </div>
    @endif
                    ...
                    <div class="col-md-6 d-flex justify-content-between">
                        <div class="search-area">
                            <form action="{{route(Route::currentRouteName())}}" method="get">
                                ...
                                <a href="{{route('admin.content.video.list')}}"  class="i-btn btn--sm danger">
            ...
            <div class="grid-container position-relative">
                ...
                <div class="row">
                    ...
                    @forelse ($contents as $content)
                        @include('partials.prompt_video_gallery')
                    @empty
                        <div class="col-12">
