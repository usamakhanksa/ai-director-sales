...
export const STRINGS: Record<string, Record<Locale, string>> = {
  ...
  "nav.unifiedSearch": { en: "Multi-Engine Search", ar: "بحث متعدد المحركات" },
  "nav.instagram": { en: "Instagram Scraper", ar: "استخراج إنستغرام" },
  "nav.twitter": { en: "Twitter / X Scraper", ar: "استخراج تويتر / إكس" },
  "nav.linkedin": { en: "LinkedIn Profile Scraper", ar: "استخراج ملف لينكدإن الشخصي" },
  "nav.linkedinSearch": { en: "LinkedIn Search", ar: "بحث لينكدإن" },
  "nav.professionalContacts": { en: "Professional Contact Finder", ar: "باحث جهات الاتصال المهنية" },
  "nav.aiScraper": { en: "Zero-Cost AI Scraper", ar: "استخراج بالذكاء الاصطناعي (مجاني)" },
  "nav.googleNews": { en: "Google News Scraper", ar: "استخراج أخبار جوجل" },
  "nav.emailVerifier": { en: "Email Verifier", ar: "التحقق من البريد الإلكتروني" },
  "nav.webhooks": { en: "Webhooks", ar: "الويب هوك" },
