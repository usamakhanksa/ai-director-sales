...
?>
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1 class="page-title"><i class="fa fa-sitemap"></i> <?php echo mlx_get_lang('Manage Docment Types'); ?> </h1>
						...
						<div class="box box-<?php echo $myHelpers->global_lib->get_skin_class(); ?>">
							<div class="box-header with-border">
								<?php if(isset($doc_type_id) && !empty($doc_type_id)){ ?>
									<h3 class="box-title"><?php echo mlx_get_lang('Edit Document Type'); ?></h3>
								<?php }else{ ?>
									<h3 class="box-title"><?php echo mlx_get_lang('Add Document Type'); ?></h3>
								<?php } ?>
							</div>
							  <div class="box-body">
			...
			?>						
								  <tr>
									...
									<td class="action_block">
										...
										<a href="<?php $segments = array('admin','document','type',$myHelpers->EncryptClientId($row->pdt_id)); 
										echo site_url($segments);?>" title="Edit" data-toggle="tooltip" class="btn btn-warning btn-xs"><i class="fa fa-edit fa-2x"></i></a>
										
										<a href="<?php $segments = array('admin','document','delete_type',$myHelpers->EncryptClientId($row->pdt_id)); 
