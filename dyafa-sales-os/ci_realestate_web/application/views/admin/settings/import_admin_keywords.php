	...
	$('.impot_lang_form').on('submit',function() {
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1 class="page-title"><i class="fa fa-download"></i> <?php echo mlx_get_lang('Import Admin Keywords'); ?> 
		  <a href="<?php echo base_url();?>admin/settings/admin_keyword_settings" class="btn btn-<?php echo $myHelpers->global_lib->get_skin_class(); ?> pull-right content-header-right-link"><?php echo mlx_get_lang('Keyword Settings'); ?></a>
		  </h1>
        ...
        <section class="content">
			...
			echo form_open_multipart('admin/settings/import_admin_keywords',$attributes); 
			
			?>
			<input type="hidden" name="lang_for" value="back">
			<div class="row">
			<div class="col-md-12">   
