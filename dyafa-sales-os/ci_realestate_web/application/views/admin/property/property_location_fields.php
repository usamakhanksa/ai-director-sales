...
<div class="row location-fields">
	...
	<div class="col-md-6 form-group">
		...
		<select class="form-control select2_elem loc_country_list" name="country" id="country_<?php echo $lang_code; ?>" <?php if($n == 1) {?>required<?php } ?>>
	...
	<div class="col-md-6 form-group">
		...
		<select class="form-control select2_elem loc_state_list" name="state" id="state_<?php echo $lang_code; ?>" <?php if($n == 0) {?>required<?php } ?>>
	...
	<div class="col-md-6 form-group">
		...
		<select class="form-control select2_elem loc_city_list" name="city" id="city_<?php echo $lang_code; ?>" <?php if($n == 0) {?>required<?php } ?>>
	...
	<div class="col-md-6 form-group">
		...
		<select class="form-control select2_elem zipcode_list" name="zipcode" id="zipcode_<?php echo $lang_code; ?>" >
	...
	<div class="col-md-6 form-group">
		...
		<select class="form-control select2_elem sub_area_list" name="sub_area" id="sub_area_<?php echo $lang_code; ?>">
