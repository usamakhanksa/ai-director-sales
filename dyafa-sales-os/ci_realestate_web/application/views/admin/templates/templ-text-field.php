...
<div class="form-group <?php echo $field_parent_class; ?>">
	<div class="row">
		...
		<div class="col-md-9">
			<input type="text" class="form-control <?php echo $field_class; ?>" <?php echo $field_attributes; ?> <?php if ($required) { ?> required="required" <?php } ?> name="<?php
																																												...
																																												?>" id="<?php echo $single_field['id']; ?>" value="<?php echo $value; ?>">
		</div>
	</div>
</div>