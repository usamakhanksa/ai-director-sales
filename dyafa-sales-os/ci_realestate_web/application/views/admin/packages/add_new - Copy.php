		...
		<div class="box-header with-border">
		  ...
		  <div class="box-body">
			...
			<?php if($enable_subscription == 'Y') { ?>
				...
				<div class="form-group child-form-group subscription_area" id="subscription_area">
			...
			<?php if($enable_property_posting == 'Y' || $enable_featured_property_posting == 'Y') { ?>
				...
				<div class="child-form-group property_area" id="property_area">
			...
			<?php if($enable_blog_posting == 'Y') { ?>
				...
				<div class="form-group child-form-group blog_area" id="blog_area">
...
<script>
		jQuery(document).ready(function(){
			...
			$(".child_show_hide").on('ifChanged',function(){
