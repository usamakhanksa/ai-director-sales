...
<div class="box box-default collapsed-box related-properties-widget widget" id="related-properties-widget">
<div class="box-header with-border">
	<h3 class="box-title">Related Properties</h3>
...
<form action="" method="post" name="related-properties" class="related-properties sidebar-widget" >
<input type="hidden" name="sidebar_for" value="" class="sidebar_for" /> 
<input type="hidden" name="sidebar_widget" value="related-properties-widget" class="" /> 
