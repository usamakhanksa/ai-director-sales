...
<section class="content-header">
  ...
  <?php if(isset($_SESSION['msg']) && !empty($_SESSION['msg']))
		...
		$app_site_menus = apply_filters("app_site_menus_extend" , $app_site_menus);
...
<section class="content">
	...
	<div class="row">
					...
					<div class="row">
						<div class="col-md-4">
							  ...
							  <select class="form-control select2_elem" name="menu_locations">
									...
									if(is_array($app_site_menus)  && count($app_site_menus) > 0){
										foreach($app_site_menus  as $menu_key => $menu_item){
											?>
									<option value="<?=$menu_key;?>" 
									<?php 
									if(isset($_POST['menu_locations']) && $_POST['menu_locations'] == $menu_key)
										echo ' selected="selected" ';
									else if(isset($cur_menu) && $cur_menu == $menu_key)
										echo ' selected="selected" ';
									?>
									><?php echo mlx_get_lang($menu_item['title']); ?></option>
		...
		<div class="col-md-8">   
			...
			<input type="hidden" name="cur_menu" value="<?php if(isset($cur_menu)) echo $cur_menu;?>">
			<div class="box box-<?php echo get_skin_class(); ?>">
				...
				<div class="box-body nestable_menus">
					...
					<input type="hidden" class="form-control" name="options[<?php echo $cur_menu; ?>]" id="json-output">
				</div>
