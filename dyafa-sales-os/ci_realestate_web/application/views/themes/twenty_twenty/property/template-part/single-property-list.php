		...
		<div class="col-md-8">
			<div class="p-4 property-body " style="border-top:0px;">
				...
				<h3 class="property-title">
					<a href="<?php echo $property_url; ?>"><?php echo ucfirst(stripcslashes($prop_row->title)); ?></a>
				</h3>
				<?php do_action("cms_property_details_after_title" , $prop_row); ?>
				
				<span class="property-location d-block mb-3">
				<span class="property-icon icon-room"></span> <?php echo ucfirst($prop_row->address); ?></span>
