      ...
      <div class="row mb-5 justify-content-center">
        <div class="col-md-7">
          <div class="site-section-title text-center">
            <h2><?php echo mlx_get_lang('Our Agents'); ?></h2>
      ...
      <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <img src="<?php echo base_url("themes/$theme"); ?>/images/person_1.jpg" alt="Image" class="img-fluid rounded mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <img src="<?php echo base_url("themes/$theme"); ?>/images/person_2.jpg" alt="Image" class="img-fluid rounded mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <img src="<?php echo base_url("themes/$theme"); ?>/images/person_3.jpg" alt="Image" class="img-fluid rounded mb-4">
