<?php
    ...
    //$whatsapp_no = $$CI->global_lib->get_user_meta($user_id, 'whatsapp_no');
    ...
    <div class="row">
        ...
        ?>
            <div class="form-group whatsapp-share-btn">
                ...
                <a class="w-inline-block social-share-btn share-whatsapp" title="Join Our Whatsapp Group" target="_blank" href="<?php echo $site_whatsapp_group_link; ?>">
        ...
        ?>
            <div class="form-group whatsapp-share-btn">
                <a class="w-inline-block social-share-btn share-whatsapp" title="Join Our Whatsapp Group" target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo $site_whatsapp_no; ?>&text=<?php //echo urlencode($whastapp_text); 
                                                                                                                                                                                                            ?>">
                    <i class="fa fa-whatsapp"></i> &nbsp;
        ...
        ?>
            <div class="form-group whatsapp-share-btn">
                <a class="w-inline-block social-share-btn share-whatsapp" title="Join Our Whatsapp Group" target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo $owner_whatsapp_no; ?>&text=<?php echo urlencode($whastapp_text); ?>">
                    <i class="fa fa-whatsapp"></i> &nbsp;
        ...
        <div class="whatsapp-share-btn">
            <a class="w-inline-block social-share-btn share-whatsapp" 
				href="https://api.whatsapp.com/send/?text=<?php echo urlencode($property_url); ?>" 
