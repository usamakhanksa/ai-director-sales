...
$enbale_agent_contact_form = get_option('enbale_agent_contact_form');
...
?>
    <div class="bg-white widget border rounded text-left" id="agent_contact_form">
        ...
        <input type="hidden" name="p_id" value="<?php echo EncryptClientID($single_property->p_id); ?>">
		...
		<?php 	do_action("contact_agent_form_extra_fields_before_message");	?>
		...
		<?php 	do_action("contact_agent_form_extra_fields");	?>
