				...
				<div class="row">
					...
					foreach ($query->result() as $data) {
						...
						if ($data->purchase_limit > 0) {
							$query = "SELECT count(packages_id) as total_bought_package from transaction where packages_id=" . $data->package_id . " and user_id=" . $user_id . "
								...
								<div class="box-footer no-padding">
									...
									<div class="lead style">
										...
										<div class="pull-right">
											<a class="btn btn-<?php echo $myHelpers->global_lib->get_skin_class(); ?> submit-form-btn" name="submit" href="<?php echo base_url('packages/subscribe/')  . $myHelpers->global_lib->EncryptClientId($data->package_id); ?>"><?php echo ucfirst($data->purchase_button_text); ?></a>
										</div>
									</div>
								</div>
