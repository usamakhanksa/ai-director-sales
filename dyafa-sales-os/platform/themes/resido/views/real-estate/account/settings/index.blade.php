...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('/vendor/core/plugins/real-estate/js/cropper.js')}}"></script>
    <script type="text/javascript" src="{{ asset('/vendor/core/plugins/real-estate/js/avatar.js')}}"></script>
